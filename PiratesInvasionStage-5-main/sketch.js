...
var waterSound,backgroundSound,pirateLaughSound,cannonSound;
      ...
      if (boats[i]) {
        ...
        if (collision.collided && !boats[i].isBroken) {
          ...
          if (!isLaughing && !pirateLaughSound.isPlaying()) {
            ...
            //uses this var to keep track of sound (only laughs once)
            isLaughing = true;
          }
          
          //sets flag to true, ending the game
          gameOver = true;
          endGame();
        }
...
function endGame () {
  ...
  swal(
    ...
    //Function that confirms to reload the page
